...
취미 수준으로 프론트엔드-React, next.js 작업과 App-Flutter 개발을 즐겨합니다.


저는 기존의 것의 불편함과 문제를 파악하고 이를 개선하여 서비스를 개발해 세상에 제공하는 것에 큰 기쁨과 흥미를 가지고 있습니다.
이와 같은 목적으로 2022년 법인을 설립하고 cto직무로 창업 활동을 진행중이며, 많은 서비스, 프로그램을 개발하고 실 서비스를 운영중에 있습니다.
...
| 2025.08.17 ~ | 명지대학교 학생회관 4층 스터디룸 대여 서비스 "띵스룸" 개발 (명지대학교 학생지원팀 수주로 2025.03.01~2025.08.01까지 개발 완료후 실 서비스 진행 중) - 역할: 프로젝트 총책임자 - PM 담당, 프론트(next.js) & 백엔드(springboot) 모두 참여, AWS기반 아키텍처 설계 및 배포, 서버 유지보수 |
| 2025.09.01 ~ | 명지대학교 산학협력단 소속 자체연구원 임용|
| 2025.09.01 ~ | 머신러닝 및 데이터 분석 기반 주식 자동매매 프로그램 연구 및 개발 진행중|
...
| 날짜 | 유형 | 제목 | 비고 |
| :--- | :--- | :--- |:--- |
| 2025.12.28 | KCI | **GIS 공간 시각화를 통한 한국 의료서비스의 공간적 분포와 불균형 지표 분석: 의료서비스와 타 서비스와의 비교** | 제 3저자, [한국지역개발학회지 제37권 제5호 2025.12/37(5)] 게재 |
